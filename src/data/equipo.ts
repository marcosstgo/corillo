...
// Qué ícono lleva la tarjeta (components/EquipoCard.astro). Sin fotos de Amazon a propósito:
// sus términos de Associates solo permiten imágenes de producto servidas por su API o SiteStripe,
// y la API no se habilita hasta las primeras 3 ventas.
export type EquipoKind = 'webcam' | 'mic' | 'capture' | 'keyboard' | 'mouse' | 'headset' | 'light' | 'arm' | 'popfilter' | 'cable' | 'hub';
...
export const ITEMS: EquipoItem[] = [
  ...
  { id: 'headset-recon70', category: 'Headset (económico)', title: 'Turtle Beach Recon 70',
    ...
    kind: 'headset', brand: 'Turtle Beach' },
...
export const GUIAS: Guia[] = [
  ...
  { slug: 'streamer-serio', title: 'El upgrade del streamer serio',
    blurb: 'Cuando ya transmites seguido y quieres que se note: mejor cámara, mejor audio, control desde el teclado.',
