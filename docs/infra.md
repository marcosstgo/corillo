# Corillo — referencia de infraestructura y backend

> Detalle que NO se carga en cada sesión. Leer solo la sección que se necesite.
> Escrito en may–jun 2026 (frontend fue rediseñado en sep 2026; ver `CLAUDE.md` para el frontend vigente).
> Antes de actuar sobre un servicio, contrastar con `systemctl status <nombre>`.
